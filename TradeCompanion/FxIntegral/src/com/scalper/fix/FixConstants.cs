...
namespace FxIntegral.com.scalper.fix
{
	...
	public struct FixConstants_Fields{
		...
		public readonly static System.String beginString42 = "FIX.4.2";
		...
		{
            lclStr = FxIntegral.com.scalper.util.FFillFixGlobals.CopyRightStr;
			ExecTypeNone = (char) SupportClass.Identity(- 1);
			OrdStatusNone = (char) SupportClass.Identity(- 1);
			legalBeginStrings = new System.String[]{FxIntegral.com.scalper.fix.FixConstants_Fields.beginString40, FxIntegral.com.scalper.fix.FixConstants_Fields.beginString41, FxIntegral.com.scalper.fix.FixConstants_Fields.beginString42, FxIntegral.com.scalper.fix.FixConstants_Fields.beginString43, FxIntegral.com.scalper.fix.FixConstants_Fields.beginString44};
			tags = new System.String[500];
			delimiter = (char) 1;
			START_FIXMSG_SIZE = FxIntegral.com.scalper.fix.FixConstants_Fields.beginStringPattern.Length + FxIntegral.com.scalper.fix.FixConstants_Fields.MAX_SKIPS + 1 + FxIntegral.com.scalper.fix.FixConstants_Fields.bodyLengthPattern.Length + FxIntegral.com.scalper.fix.FixConstants_Fields.MAX_BODY_LENGTH_DIGITS + 1;
			END_FIXMSG_SIZE = FxIntegral.com.scalper.fix.FixConstants_Fields.checksumPattern.Length + FxIntegral.com.scalper.fix.FixConstants_Fields.MAX_CHECKSUM_DIGITS + 1;
		}
	}
