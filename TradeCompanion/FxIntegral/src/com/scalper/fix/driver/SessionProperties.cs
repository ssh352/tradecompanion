...
using ConfigurationProperties = FxIntegral.com.scalper.util.ConfigurationProperties;
namespace  FxIntegral.com.scalper.fix.driver
{
	...
	public class SessionProperties:System.Collections.Specialized.NameValueCollection //, ConfigurationProperties
	{
		...
		protected internal virtual System.Object setDefault(System.String key, System.String value_Renamed)
		{
            ...
            return defaults is FxIntegral.com.scalper.fix.driver.SessionProperties?((FxIntegral.com.scalper.fix.driver.SessionProperties) defaults).setProperty(key, value_Renamed):tempObject;
		}
