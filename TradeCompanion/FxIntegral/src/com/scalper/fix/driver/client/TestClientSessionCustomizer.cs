...
/// </summary>
using System;
using ClientSessionCustomizer = FxIntegral.com.scalper.fix.driver.ClientSessionCustomizer;
using FIXPersister = FxIntegral.com.scalper.fix.driver.FIXPersister;
using FIXVolatilePersister = FxIntegral.com.scalper.fix.driver.FIXVolatilePersister;
