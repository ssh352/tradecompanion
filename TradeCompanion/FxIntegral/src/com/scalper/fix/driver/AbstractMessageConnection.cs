...
namespace  FxIntegral.com.scalper.fix.driver
{
	...
	{
		public abstract FxIntegral.com.scalper.fix.driver.FIXConnection Connection{get;}
        ...
        public abstract void getParsedMessage(FxIntegral.com.scalper.fix.Message param1, System.Object param2, FxIntegral.com.scalper.fix.TagHelper param3, bool param4);
		public abstract void  sendMessages(System.Object[] param1);
        public abstract void sendMessage(FxIntegral.com.scalper.fix.Message param1);
	}
}