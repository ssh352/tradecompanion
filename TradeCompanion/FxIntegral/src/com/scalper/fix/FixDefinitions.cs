...
/// </summary>
using System;
using CfgReader = FxIntegral.com.scalper.util.CfgReader;
using log4net;
...
namespace FxIntegral.com.scalper.fix
{
	...
	public class FixDefinitions
	{
		...
		{
			lock (typeof(FxIntegral.com.scalper.fix.FixDefinitions))
			{
		...
		public static FixDefinitions getFIXDefinition()
		{
			lock (typeof(FxIntegral.com.scalper.fix.FixDefinitions))
			{
				if (FixDefinitions.fixDefinitions == null)
				{
					...
					FixDefinitions.getFIXDefinition(FxIntegral.com.scalper.fix.FixConstants_Fields.beginString42, ref tempAux);
				}
				return FixDefinitions.fixDefinitions;
			}
		}
