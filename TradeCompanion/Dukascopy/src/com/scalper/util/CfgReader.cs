    ...
    public class CfgReader : ConfigurationProperties
    {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    if ((nextLine.Trim().StartsWith("[")) && (nextLine.Trim().IndexOf("]") > 0))
                    {
                        ...
                        //if (ini_hash_props is Dukascopy.com.scalper.fix.driver.SessionProperties)
                        //    ((Dukascopy.com.scalper.fix.driver.SessionProperties)ini_hash_props).put(ini_section, tmp_props);
                        //else
        ...
        public virtual bool addIniSection(System.String ini_section_name)
        {
            ...
            if (tmp_props == null)
            {
                ...
                ini_props.Add(tmp_props);
                //if (ini_hash_props is Dukascopy.com.scalper.fix.driver.SessionProperties)
                //    ((Dukascopy.com.scalper.fix.driver.SessionProperties)ini_hash_props).put(ini_section_name, tmp_props);
                //else
        ...
        public virtual bool setProperty(System.String ini_section_name, System.String name, System.String value_Renamed)
        {
            ...
            if (v == null)
            {
                ...
                ini_props.Add(v);
                //if (ini_hash_props is Dukascopy.com.scalper.fix.driver.SessionProperties)
                //    ((Dukascopy.com.scalper.fix.driver.SessionProperties)ini_hash_props).put(ini_section_name, v);
                //else
