...
/// </summary>
using System;
using ClientSessionCustomizer = Dukascopy.com.scalper.fix.driver.ClientSessionCustomizer;
using FIXPersister = Dukascopy.com.scalper.fix.driver.FIXPersister;
using FIXVolatilePersister = Dukascopy.com.scalper.fix.driver.FIXVolatilePersister;
