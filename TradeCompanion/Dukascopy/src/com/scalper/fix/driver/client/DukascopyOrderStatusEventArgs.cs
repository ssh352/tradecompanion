...
{
    public class DukascopyOrderStatusEventArgs : EventArgs
    {
        public DukascopyOrderStatusEventArgs(Dukascopy.com.scalper.fix.Message m)
        {
            this._fixMsg = m;
        }
        ...
        public System.Int32 FilledQty
        {
            get
            {
                ...
                {
                    if (this._fixMsg != null)
                        retVal = System.Int32.Parse(this._fixMsg.getStringFieldValue(Constants_Fields.TAGCumQty_i));
                }
                catch //(Exception e)
                {
                    //Do Nothing
        ...
        public Dukascopy.com.scalper.fix.Message _fixMsg;
    }
}
