...
using ConfigurationProperties = Dukascopy.com.scalper.util.ConfigurationProperties;
namespace  Dukascopy.com.scalper.fix.driver
{
	...
	public class SessionProperties:System.Collections.Specialized.NameValueCollection //, ConfigurationProperties
	{
		...
		protected internal virtual System.Object setDefault(System.String key, System.String value_Renamed)
		{
            ...
            return defaults is Dukascopy.com.scalper.fix.driver.SessionProperties?((Dukascopy.com.scalper.fix.driver.SessionProperties) defaults).setProperty(key, value_Renamed):tempObject;
		}
