...
namespace Dukascopy.com.scalper.fix
{
	...
	public struct FixConstants_Fields{
		...
		{
            lclStr = Dukascopy.com.scalper.util.FFillFixGlobals.CopyRightStr;
			ExecTypeNone = (char) SupportClass.Identity(- 1);
			OrdStatusNone = (char) SupportClass.Identity(- 1);
			legalBeginStrings = new System.String[]{Dukascopy.com.scalper.fix.FixConstants_Fields.beginString40, Dukascopy.com.scalper.fix.FixConstants_Fields.beginString41, Dukascopy.com.scalper.fix.FixConstants_Fields.beginString42, Dukascopy.com.scalper.fix.FixConstants_Fields.beginString43, Dukascopy.com.scalper.fix.FixConstants_Fields.beginString44};
			tags = new System.String[500];
			delimiter = (char) 1;
			START_FIXMSG_SIZE = Dukascopy.com.scalper.fix.FixConstants_Fields.beginStringPattern.Length + Dukascopy.com.scalper.fix.FixConstants_Fields.MAX_SKIPS + 1 + Dukascopy.com.scalper.fix.FixConstants_Fields.bodyLengthPattern.Length + Dukascopy.com.scalper.fix.FixConstants_Fields.MAX_BODY_LENGTH_DIGITS + 1;
			END_FIXMSG_SIZE = Dukascopy.com.scalper.fix.FixConstants_Fields.checksumPattern.Length + Dukascopy.com.scalper.fix.FixConstants_Fields.MAX_CHECKSUM_DIGITS + 1;
		}
	}
