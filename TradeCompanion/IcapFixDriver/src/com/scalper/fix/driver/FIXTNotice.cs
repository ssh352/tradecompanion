...
namespace Icap.com.scalper.fix.driver
{
	...
	public class FIXTNotice
	{
        ...
        public const int FIX_APP_LOGON_SUCCESS = 29;
        public const int FIX_APP_LOGON_FAILS = 30;
        public const int FIX_PASS_CHANGED = 31;
        public const int FIX_PASS_CHANGE_FAILED = 32;
        public const int FIX_PASS_EXPIRED = 33;
        public const int FIX_CANCEL_DUP_SESSION = 34;
		
		public const int NUM_NOTICE_TYPES = 35;
		...
		/// </param>
		public FIXTNotice(System.Object src, FIXConnection conn, int code, System.String text):this(src, null, null, conn, code, text)
		{
		}
		...
		/// <param name="msg	Additional">message that you want to attach to notice.
		/// </param>
        public FIXTNotice(System.Object src, Message msg, ScalperFixSession session, int code, System.String text)
        ...
        private FIXTNotice(System.Object src, Message message, ScalperFixSession session, FIXConnection conn, int code, System.String text)
		{
