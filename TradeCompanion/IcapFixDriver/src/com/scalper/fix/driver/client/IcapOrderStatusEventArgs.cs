...
{
    public class IcapOrderStatusEventArgs : EventArgs
    {
        public IcapOrderStatusEventArgs(Icap.com.scalper.fix.Message m)
        {
            this._fixMsg = m;
        }
        ...
        public System.Int32 FilledQty
        {
            get
            {
                ...
                {
                    if (this._fixMsg != null)
                        retVal = System.Int32.Parse(this._fixMsg.getStringFieldValue(Constants_Fields.TAGCumQty));
                }
                catch //(Exception e)
                {
                    //Do Nothing
        ...
        public System.Double Price
        {
            get
            {
                ...
                {
                    if (this._fixMsg != null)
                        price = System.Double.Parse(this._fixMsg.getStringFieldValue(Constants_Fields.TAGPrice), util.BasicUtilities.getCulture());
                }
                catch //(Exception e)
                {
                    //Do Nothing
