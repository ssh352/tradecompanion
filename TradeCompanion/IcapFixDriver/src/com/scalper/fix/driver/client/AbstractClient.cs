...
namespace Icap.com.scalper.fix.driver.client
{
    ...
    public delegate void FIXResponseEventHandler(object sender, FIXTResponseEventArgs args);
	...
	public abstract class AbstractClient : Client
	{
		...
		private class AnonymousClassFIXNoticeListener : FIXNoticeListener
		{
			...
			{
                FIXTResponseEventArgs ev = new FIXTResponseEventArgs(notice);
		...
		public virtual void  sendMessage(Message msg)
		{
			...
			if (!setInitialValues)
			{
				System.String senderCompID = msg.getValue(Icap.com.scalper.fix.Constants_Fields.TAGSenderCompID_i);
				if (senderCompID != null)
				{
					session.SenderCompID = senderCompID;
				}
				
				System.String targetCompID = msg.getValue(Icap.com.scalper.fix.Constants_Fields.TAGTargetCompID_i);
		...
		{
			Message msg = new Message(Icap.com.scalper.fix.Constants_Fields.MSGHeartbeat);
		...
		public virtual Message accept(long timeout)
		{
			...
			// @todo
			if (message != null && !BasicFixUtilities.isAdmin(message) && message.getCharValue(Icap.com.scalper.fix.Constants_Fields.TAGPossDupFlag) != 'Y')
		...
		protected internal static bool isSequenceReset_Reset(Message msg)
		{
			...
			if (Icap.com.scalper.fix.Constants_Fields.MSGSequenceReset.Equals(msgType))
			{
				char gapFillFlag = msg.getCharValue(Icap.com.scalper.fix.Constants_Fields.TAGGapFillFlag_i);
