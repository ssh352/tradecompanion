...
namespace Icap.com.scalper.fix.driver
{
	...
	public class FIXVolatilePersister : FIXPersister
	{
		...
		public virtual void  storeOutboundAppMessage(Message message)
		{
			...
			{
				if (cacheOutMessages)
                    //if (outMessageStore is Icap.com.scalper.fix.driver.SessionProperties)
                    //    ((Icap.com.scalper.fix.driver.SessionProperties) outMessageStore).put((System.Int32) msgSeqNum, message);
                    //else
		...
		{
			if (endSeqNo == Icap.com.scalper.fix.Constants_Fields.RESEND_INFINITY_40_41 || endSeqNo == Icap.com.scalper.fix.Constants_Fields.RESEND_INFINITY_42)
			{
