...
namespace Icap.com.scalper.fix.driver
{
	...
	{
		public abstract Icap.com.scalper.fix.driver.FIXConnection Connection{get;}
		...
		public abstract void  getParsedMessage(Icap.com.scalper.fix.Message param1, System.Object param2, Icap.com.scalper.fix.TagHelper param3, bool param4);
		public abstract void  sendMessages(System.Object[] param1);
		public abstract void  sendMessage(Icap.com.scalper.fix.Message param1);
	}
}