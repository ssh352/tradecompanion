...
namespace Icap.com.scalper.fix
{
    ...
    public class BasicFixUtilities
    {
        ...
        private static readonly String PATTERN_4x = "([^1]*[.])?[1][.](?<minorVersion>[0-9])*";

        internal static readonly System.String lclStr = Icap.com.scalper.util.FFillFixGlobals.DisplayCopyRightStr;
            ...
            try
            {
                for (int i = 0; i < step_msg.size(); i++)
                {
                    ...
                    if (!BasicFixUtilities.isIgnoreTag(stepTag, skipTags))
                    {
                        ...
                        {
                            if ((stepTag.Equals(Icap.com.scalper.fix.Constants_Fields.TAGClOrdID)) || (stepTag.Equals(Icap.com.scalper.fix.Constants_Fields.TAGOrigClOrdID)))
                            {
                        ...
                        if (listIDMap != null)
                        {
                            if (stepTag.Equals(Icap.com.scalper.fix.Constants_Fields.TAGListID))
                            {
        ...
        public static bool isAdmin(System.String msgType)
        {
            try
            {
                ...
                isAdminMsg = isAdminMsg && (msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGLogon) || msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGLogout) || msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGResendRequest) || msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGHeartbeat) || msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGTestRequest) || msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGSequenceReset) || msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGReject));
                return isAdminMsg;
            }
            catch (System.Exception e)
            {
        ...
        public static bool isReject(Message msg)
        {
            try
            {
                System.String msgType = msg.getValue(Icap.com.scalper.fix.Constants_Fields.TAGMsgType);
                return ((msgType != null) && (msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGReject)));
            }
            catch (System.Exception e)
            {
                log.Error(e);
        ...
        public static bool isResend(Message msg)
        {
            ...
            {
                System.String msgType = msg.getValue(Icap.com.scalper.fix.Constants_Fields.TAGMsgType);
                return ((msgType != null) && (msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGResendRequest)));
            }
            catch (System.Exception e)
            {
                log.Error(e);
        ...
        {
            return ((msgType != null) && (msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGHeartbeat) || (msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGTestRequest)) || (msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGResendRequest)) || (msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGLogout)) || (msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGLogon)) || (msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGReject)) || (msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGSequenceReset))));
        }
        ...
        public static bool isLogon(System.String msgType)
        {
            try
            {
                return ((msgType != null) && (msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGLogon)));
            }
            catch (System.Exception e)
            {
                log.Error(e);
        ...
        public static bool isLogout(System.String msgType)
        {
            try
            {
                return ((msgType != null) && (msgType.Equals(Icap.com.scalper.fix.Constants_Fields.MSGLogout)));
            }
            catch (System.Exception e)
            {
                log.Error(e);
