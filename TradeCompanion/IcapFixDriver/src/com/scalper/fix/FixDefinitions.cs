...
/// </summary>
using System;
using CfgReader = Icap.com.scalper.util.CfgReader;
using log4net;
...
namespace Icap.com.scalper.fix
{
    ...
    public class FixDefinitions
    {
        ...
        {
            lock (typeof(Icap.com.scalper.fix.FixDefinitions))
            {
        ...
        public static FixDefinitions getFIXDefinition()
        {
            lock (typeof(Icap.com.scalper.fix.FixDefinitions))
            {
                if (FixDefinitions.fixDefinitions == null)
                {
                    ...
                    FixDefinitions.getFIXDefinition(Icap.com.scalper.fix.FixConstants_Fields.beginString42, ref tempAux);
                }
                return FixDefinitions.fixDefinitions;
            }
        }
