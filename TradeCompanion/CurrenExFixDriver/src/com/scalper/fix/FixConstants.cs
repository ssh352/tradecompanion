...
namespace com.scalper.fix
{
	...
	public struct FixConstants_Fields{
		...
		{
			lclStr = com.scalper.util.FFillFixGlobals.CopyRightStr;
			ExecTypeNone = (char) SupportClass.Identity(- 1);
			OrdStatusNone = (char) SupportClass.Identity(- 1);
			legalBeginStrings = new System.String[]{com.scalper.fix.FixConstants_Fields.beginString40, com.scalper.fix.FixConstants_Fields.beginString41, com.scalper.fix.FixConstants_Fields.beginString42, com.scalper.fix.FixConstants_Fields.beginString43, com.scalper.fix.FixConstants_Fields.beginString44};
			tags = new System.String[500];
			delimiter = (char) 1;
			START_FIXMSG_SIZE = com.scalper.fix.FixConstants_Fields.beginStringPattern.Length + com.scalper.fix.FixConstants_Fields.MAX_SKIPS + 1 + com.scalper.fix.FixConstants_Fields.bodyLengthPattern.Length + com.scalper.fix.FixConstants_Fields.MAX_BODY_LENGTH_DIGITS + 1;
			END_FIXMSG_SIZE = com.scalper.fix.FixConstants_Fields.checksumPattern.Length + com.scalper.fix.FixConstants_Fields.MAX_CHECKSUM_DIGITS + 1;
		}
	}
