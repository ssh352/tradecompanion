...
namespace com.scalper.fix
{
    ...
    public class BasicFixUtilities
    {
        ...
        internal static readonly System.String lclStr = com.scalper.util.FFillFixGlobals.DisplayCopyRightStr;
            ...
            try
            {
                for (int i = 0; i < step_msg.size(); i++)
                {
                    ...
                    if (!BasicFixUtilities.isIgnoreTag(stepTag, skipTags))
                    {
                        ...
                        {
                            if ((stepTag.Equals(com.scalper.fix.Constants_Fields.TAGClOrdID)) || (stepTag.Equals(com.scalper.fix.Constants_Fields.TAGOrigClOrdID)))
                            {
                        ...
                        if (listIDMap != null)
                        {
                            if (stepTag.Equals(com.scalper.fix.Constants_Fields.TAGListID))
                            {
        ...
        {
            System.Console.Error.WriteLine(BasicFixUtilities.lclStr);

            System.Console.Error.WriteLine("BasicFixUtilities test");
            System.String lVer;
            char c;
            lVer = "FIX.4.1";
            c = BasicFixUtilities.getFixMinorVersion(lVer);
            System.Console.Error.WriteLine("BasicFixUtilities: Got '" + c + "' for '" + lVer + "'");
            lVer = "TEST.4.4.8";
            c = BasicFixUtilities.getFixMinorVersion(lVer);
            System.Console.Error.WriteLine("BasicFixUtilities: Got '" + c + "' for '" + lVer + "'");
        }
        ...
        public static bool isAdmin(System.String msgType)
        {
            try
            {
                ...
                isAdminMsg = isAdminMsg && (msgType.Equals(com.scalper.fix.Constants_Fields.MSGLogon) || msgType.Equals(com.scalper.fix.Constants_Fields.MSGLogout) || msgType.Equals(com.scalper.fix.Constants_Fields.MSGResendRequest) || msgType.Equals(com.scalper.fix.Constants_Fields.MSGHeartbeat) || msgType.Equals(com.scalper.fix.Constants_Fields.MSGTestRequest) || msgType.Equals(com.scalper.fix.Constants_Fields.MSGSequenceReset) || msgType.Equals(com.scalper.fix.Constants_Fields.MSGReject));
                return isAdminMsg;
            }
            catch (System.Exception e)
            {
        ...
        public static bool isReject(Message msg)
        {
            try
            {
                System.String msgType = msg.getValue(com.scalper.fix.Constants_Fields.TAGMsgType);
                return ((msgType != null) && (msgType.Equals(com.scalper.fix.Constants_Fields.MSGReject)));
            }
            catch (System.Exception e)
            {
                log.Error(e);
        ...
        public static bool isResend(Message msg)
        {
            ...
            {
                System.String msgType = msg.getValue(com.scalper.fix.Constants_Fields.TAGMsgType);
                return ((msgType != null) && (msgType.Equals(com.scalper.fix.Constants_Fields.MSGResendRequest)));
            }
            catch (System.Exception e)
            {
                log.Error(e);
        ...
        {
            return ((msgType != null) && (msgType.Equals(com.scalper.fix.Constants_Fields.MSGHeartbeat) || (msgType.Equals(com.scalper.fix.Constants_Fields.MSGTestRequest)) || (msgType.Equals(com.scalper.fix.Constants_Fields.MSGResendRequest)) || (msgType.Equals(com.scalper.fix.Constants_Fields.MSGLogout)) || (msgType.Equals(com.scalper.fix.Constants_Fields.MSGLogon)) || (msgType.Equals(com.scalper.fix.Constants_Fields.MSGReject)) || (msgType.Equals(com.scalper.fix.Constants_Fields.MSGSequenceReset))));
        }
        ...
        public static bool isLogon(System.String msgType)
        {
            try
            {
                return ((msgType != null) && (msgType.Equals(com.scalper.fix.Constants_Fields.MSGLogon)));
            }
            catch (System.Exception e)
            {
                log.Error(e);
        ...
        public static bool isLogout(System.String msgType)
        {
            try
            {
                return ((msgType != null) && (msgType.Equals(com.scalper.fix.Constants_Fields.MSGLogout)));
            }
            catch (System.Exception e)
            {
                log.Error(e);
