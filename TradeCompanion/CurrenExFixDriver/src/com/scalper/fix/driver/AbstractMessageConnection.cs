...
namespace com.scalper.fix.driver
{
	...
	{
		public abstract com.scalper.fix.driver.FIXConnection Connection{get;}
		...
		public abstract void  getParsedMessage(com.scalper.fix.Message param1, System.Object param2, com.scalper.fix.TagHelper param3, bool param4);
		public abstract void  sendMessages(System.Object[] param1);
		public abstract void  sendMessage(com.scalper.fix.Message param1);
	}
}