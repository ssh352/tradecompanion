...
/// </summary>
using System;
using ClientSessionCustomizer = com.scalper.fix.driver.ClientSessionCustomizer;
using FIXPersister = com.scalper.fix.driver.FIXPersister;
using FIXVolatilePersister = com.scalper.fix.driver.FIXVolatilePersister;
