...
{
    public class CurrenExOrderStatusEventArgs : EventArgs
    {
        public CurrenExOrderStatusEventArgs(com.scalper.fix.Message m)
        {
            this._fixMsg = m;
        }
        ...
        public System.Double Price
        {
            get
            {
                ...
                {
                    if (this._fixMsg != null)
                        price = System.Double.Parse(this._fixMsg.getStringFieldValue(Constants_Fields.TAGLastPx),util.BasicUtilities.getCulture());
                }
                catch //(Exception e)
                {
                    //Do Nothing
