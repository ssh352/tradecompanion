<%@ Page language="c#" MasterPageFile="MstForContents.master" Inherits="Forum.reply" CodeFile="~/Forum/reply.cs" %>
...
<table><tr><td valign="top" >
	...
	<table   id="original_holder" runat="Server" width="100%">
	<tr><td colspan="2"
...
<tr><td style="background-color: D7D7FF; width: 150px">
...
<tr>
	<td style="background-color: #f2f2f2; width: 150px"><font style="font-family: Arial; font-size: 13px; font-weight: bold; color: #0033cc">
        Message*</font>
...
style="font-family: Arial; font-size: 13px" TextMode=MultiLine Rows=12 Columns=50 runat="server">
