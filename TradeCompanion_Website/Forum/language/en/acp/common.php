...
// Index page
$lang = array_merge($lang, array(
	'ADMIN_INTRO'				=> 'Thank you for choosing Scalper as your board solution. This screen will give you a quick overview of all the various statistics of your board. The links on the left hand side of this screen allow you to control every aspect of your board experience. Each page will have instructions on how to use the tools.',
	...
	'WELCOME_PHPBB'			=> 'Welcome to Scalper',
));
...
$lang = array_merge($lang, array(
	...
	'LOG_INSTALL_CONVERTED'	=> '<strong>Converted from %1$s to Scalper %2$s</strong>',
	'LOG_INSTALL_INSTALLED'	=> '<strong>Installed Scalper %s</strong>',
