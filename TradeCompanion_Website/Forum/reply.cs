...
// reply Check Event end
        ...
        string p2_smiley_id = CCUtility.ToSQL(this.reply_smiley_id.Value, FieldTypes.Number);
        string p2_topic = CCUtility.ToSQL(this.reply_topic.Text, FieldTypes.Text);
        string p2_author = CCUtility.ToSQL(this.reply_author.Text, FieldTypes.Text);
        string p2_message = CCUtility.ToSQL(this.reply_message.Text, FieldTypes.Memo);
        string p2_date_entered = CCUtility.ToSQL(this.reply_date_entered.Value, FieldTypes.Date);
        string p2_last_modified = CCUtility.ToSQL(this.reply_last_modified.Value, FieldTypes.Date);
        string p2_mid = CCUtility.ToSQL(this.reply_mid.Value, FieldTypes.Number);
