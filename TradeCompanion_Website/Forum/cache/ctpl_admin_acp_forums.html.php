...
<?php if ($this->_rootref['S_EDIT_FORUM']) {  ?>
	...
	<dl>
		...
		<dd><input type="password" id="forum_password" name="forum_password" value="<?php echo (isset($this->_rootref['FORUM_PASSWORD'])) ? $this->_rootref['FORUM_PASSWORD'] : ''; ?>" /></dd>
	</dl>
	<dl>
		...
		<dd><input type="password" id="forum_password_confirm" name="forum_password_confirm" value="<?php echo (isset($this->_rootref['FORUM_PASSWORD_CONFIRM'])) ? $this->_rootref['FORUM_PASSWORD_CONFIRM'] : ''; ?>" /></dd>
	</dl>
	<dl>
...
<?php } else if ($this->_rootref['S_CONTINUE_SYNC']) {  ?>
	...
	<!--
		...
		window.open('<?php echo (isset($this->_rootref['UA_PROGRESS_BAR'])) ? $this->_rootref['UA_PROGRESS_BAR'] : ''; ?>', '_sync', 'height=240, resizable=yes, scrollbars=no, width=400');
