...
<dl>
	...
	<dd>[ <a href="#" onclick="window.open('<?php echo (isset($this->_rootref['U_WHOIS'])) ? $this->_rootref['U_WHOIS'] : ''; ?>', '_whois', 'height=500, resizable=yes, scrollbars=yes, width=700'); return false;"><?php echo ((isset($this->_rootref['L_WHOIS'])) ? $this->_rootref['L_WHOIS'] : ((isset($user->lang['WHOIS'])) ? $user->lang['WHOIS'] : '{ WHOIS }')); ?></a> ]</dd>
</dl>
<?php } ?>
<dl>
