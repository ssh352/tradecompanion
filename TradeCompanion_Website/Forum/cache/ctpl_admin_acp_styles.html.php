...
<?php if ($this->_rootref['S_DELETE']) {  ?>
	...
	<dl>
		...
		<dd><select name="new_id"><?php echo (isset($this->_rootref['S_REPLACE_OPTIONS'])) ? $this->_rootref['S_REPLACE_OPTIONS'] : ''; ?></select></dd>
	</dl>
...
<?php } else if ($this->_rootref['S_EDIT_IMAGESET']) {  ?>
	...
	<!--
		...
		{
			document.getElementById('newimg').src = (newimage) ? "../styles/<?php echo (isset($this->_rootref['NAME'])) ? $this->_rootref['NAME'] : ''; ?>/imageset/" + newimage : "images/no_image.png";
		}
	//-->
	</script>
	...
	<div id="img_dimensions">
		<dl>
			...
			<dd><input type="text" name="imgwidth" value="<?php echo (isset($this->_rootref['IMAGE_SIZE'])) ? $this->_rootref['IMAGE_SIZE'] : ''; ?>" /></dd>
		</dl>
		<dl>
			...
			<dd><input type="text" name="imgheight" value="<?php echo (isset($this->_rootref['IMAGE_HEIGHT'])) ? $this->_rootref['IMAGE_HEIGHT'] : ''; ?>" /></dd>
		</dl>
	</div>
	</fieldset>
...
<?php } else if ($this->_rootref['S_EDIT_TEMPLATE'] || $this->_rootref['S_EDIT_THEME']) {  ?>
	...
	<form name="acp_styles" method="post" action="<?php echo (isset($this->_rootref['U_ACTION'])) ? $this->_rootref['U_ACTION'] : ''; ?>">
	...
	<?php $_file_count = (isset($this->_tpldata['file'])) ? sizeof($this->_tpldata['file']) : 0;if ($_file_count) {for ($_file_i = 0; $_file_i < $_file_count; ++$_file_i){$_file_val = &$this->_tpldata['file'][$_file_i]; if (!($_file_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1"><?php } else { ?><tr class="row2"><?php } ?>
			<td><a href="<?php echo $_file_val['U_VIEWSOURCE']; ?>" onclick="viewsource('<?php echo $_file_val['UA_VIEWSOURCE']; ?>');return false"><?php echo $_file_val['FILENAME']; ?></a></td>
...
<?php } else if ($this->_rootref['S_FRONTEND']) {  ?>
	...
	<dl>
		...
		<dd><?php if ($this->_rootref['S_INSTALL']) {  ?><b id="name"><?php echo (isset($this->_rootref['NAME'])) ? $this->_rootref['NAME'] : ''; ?></b><?php } else { ?><input type="text" id="name" name="name" value="<?php echo (isset($this->_rootref['NAME'])) ? $this->_rootref['NAME'] : ''; ?>" /><?php } ?></dd>
	</dl>
	<dl>
		...
		<dd><?php if ($this->_rootref['S_INSTALL']) {  ?><b id="name"><?php echo (isset($this->_rootref['COPYRIGHT'])) ? $this->_rootref['COPYRIGHT'] : ''; ?></b><?php } else { ?><input type="text" id="copyright" name="copyright" value="<?php echo (isset($this->_rootref['COPYRIGHT'])) ? $this->_rootref['COPYRIGHT'] : ''; ?>" /><?php } ?></dd>
	</dl>
	<?php if ($this->_rootref['S_STYLE'] && ! $this->_rootref['S_BASIS']) {  ?>
		<dl>
			...
			<dd><?php if ($this->_rootref['S_INSTALL']) {  ?><b id="template_id"><?php echo (isset($this->_rootref['TEMPLATE_NAME'])) ? $this->_rootref['TEMPLATE_NAME'] : ''; ?></b><?php } else { ?><select id="template_id" name="template_id"><?php echo (isset($this->_rootref['S_TEMPLATE_OPTIONS'])) ? $this->_rootref['S_TEMPLATE_OPTIONS'] : ''; ?></select><?php } ?></dd>
		</dl>
		<dl>
			...
			<dd><?php if ($this->_rootref['S_INSTALL']) {  ?><b id="theme_id"><?php echo (isset($this->_rootref['THEME_NAME'])) ? $this->_rootref['THEME_NAME'] : ''; ?></b><?php } else { ?><select id="theme_id" name="theme_id"><?php echo (isset($this->_rootref['S_THEME_OPTIONS'])) ? $this->_rootref['S_THEME_OPTIONS'] : ''; ?></select><?php } ?></dd>
		</dl>
		<dl>
			...
			<dd><?php if ($this->_rootref['S_INSTALL']) {  ?><b id="imageset_id"><?php echo (isset($this->_rootref['IMAGESET_NAME'])) ? $this->_rootref['IMAGESET_NAME'] : ''; ?></b><?php } else { ?><select id="imageset_id" name="imageset_id"><?php echo (isset($this->_rootref['S_IMAGESET_OPTIONS'])) ? $this->_rootref['S_IMAGESET_OPTIONS'] : ''; ?></select><?php } ?></dd>
		</dl>
	<?php } if ($this->_rootref['S_TEMPLATE'] || $this->_rootref['S_THEME']) {  ?>
		<dl>
			...
			<dd><label><input type="radio" class="radio" name="store_db" value="0"<?php if (! $this->_rootref['S_STORE_DB']) {  ?> id="store_db" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_STORE_FILESYSTEM'])) ? $this->_rootref['L_STORE_FILESYSTEM'] : ((isset($user->lang['STORE_FILESYSTEM'])) ? $user->lang['STORE_FILESYSTEM'] : '{ STORE_FILESYSTEM }')); ?></label>
				<label><input type="radio" class="radio" name="store_db" value="1"<?php if ($this->_rootref['S_STORE_DB']) {  ?> id="store_db" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_STORE_DATABASE'])) ? $this->_rootref['L_STORE_DATABASE'] : ((isset($user->lang['STORE_DATABASE'])) ? $user->lang['STORE_DATABASE'] : '{ STORE_DATABASE }')); ?></label></dd>
		</dl>
	<?php } if ($this->_rootref['S_STYLE']) {  ?>
		</fieldset>
