//Contents for menu 1
var menu1=new Array()
menu1[0]='<a href="Forms/FrmTradeComp.aspx">Trade Companion</a>'
...
menu2[1]='<a href="Forms/FrmSystems_Forex.aspx">Forex</a>'
...
//function gettime(){
////var now = new Date("25-9-2006 06:20:16 PM");
...
//document.getElementById('txtlondon').value = now.getHours()+":"+now.getMinutes();
//}
