...
Partial Class Forms_FrmHitBanner
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        lDataAccess.objCommand.CommandText = "Update Banners SET hits = hits + 1 where LinkNum = " & LinkId
        ...
        lDataAccess.objCommand.CommandText = "Select BannerLink from Banners where LinkNum = " & LinkId
